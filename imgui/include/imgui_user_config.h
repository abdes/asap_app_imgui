...
// implement default
// clipboard handler. Won't use and link with
// OpenClipboard/GetClipboardData/CloseClipboard etc.
//#define IMGUI_DISABLE_WIN32_DEFAULT_IME_FUNCTIONS         // [Win32] Don't
// implement default IME
// handler. Won't use and link with ImmGetContext/ImmSetCompositionWindow.
...
// #define IMGUI_DISABLE_DEFAULT_ALLOCATORS // Don't implement default
// allocators calling malloc()/free(). You will need to call
// ImGui::SetAllocatorFunctions().

//---- Include imgui_user.h at the end of imgui.h as a convenience
//#define IMGUI_INCLUDE_IMGUI_USER_H

//---- Pack colors to BGRA8 instead of RGBA8 (if you needed to convert from one
// to another anyway) #define IMGUI_USE_BGRA_PACKED_COLOR
