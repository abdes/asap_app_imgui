...
# because it requires all code, including third party and system libraries 
# to be built with it.
#
...
# requested sanitizer.
# Failure to do so will not abort the CMake generation, but will print a 
# message when the compiler does not support the requested sanitizer.
# 
# ------------------------------------------------------------------------------
...
function(enable_google_asan target)
  ...
  if (COMPILER_SUPPORTS_ASAN)
    ...
    if (NOT TARGET internal_asan)
      ...
      set_target_properties(internal_asan PROPERTIES
...
function(enable_google_ubsan target)
  # To use UBSan, compile and link your program with -fsanitize=undefined.
  # To get nicer output for file names, we'll only keep the last 3 components of
  # the path.
  set(SANITIZER_FLAGS_UBSAN 
        "-fsanitize=undefined" "-fsanitize-undefined-strip-path-components=-2")
  ...
  if (COMPILER_SUPPORTS_UBSAN)
    ...
    if (NOT TARGET internal_ubsan)
      ...
      set_target_properties(internal_ubsan PROPERTIES
...
function(enable_google_tsan target)
  ...
  if (COMPILER_SUPPORTS_TSAN)
    ...
    if (NOT TARGET internal_tsan)
      ...
      set_target_properties(internal_tsan PROPERTIES
        INTERFACE_COMPILE_OPTIONS "${SANITIZER_FLAGS_TSAN}"
